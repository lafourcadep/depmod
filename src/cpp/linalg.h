...
inline Matrix3d rotation_matrix_from_vectors(Ref<Vector3d> u, Ref<Vector3d> v) {
...
inline Matrix3d rotation_matrix_around_axis(Ref<Vector3d> axis, double angle) {
...
inline void align_to_lammps_convention(Ref<Matrix3d> G, Ref<Matrix3d> H, Ref<Vector3d> zaxis) {
...
inline void align_to_lammps_convention(Ref<Matrix3d> G, Ref<Matrix3d> H) {
