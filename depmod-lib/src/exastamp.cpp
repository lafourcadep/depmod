...
static const std::map<uint32_t, xsp_function_t> EXASTAMP_METHODS = {
  { INTEGRATION_METHOD::BRUTE,                            &_exastamp_box_gen_brute_n },
  { INTEGRATION_METHOD::BRUTE | INTEGRATION_METHOD::KPTS, &_exastamp_box_gen_brute_k },
};

const std::map<uint32_t, xsp_function_t>& exastamp_methods() {
  return EXASTAMP_METHODS;
};


void _exastamp_box_gen_brute_n(Configuration* config, Deformation* deform, py::array_t<double> t, py::array_t<double> F) {
...
void _exastamp_box_gen_brute_k(Configuration* config, Deformation* deform, py::array_t<double> t, py::array_t<double> F) {
